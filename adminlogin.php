...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $sql = "SELECT id, clubname, email, password FROM admins WHERE email = ? AND clubname = ?";
    ...
    if ($result->num_rows == 1) {
        ...
        if (password_verify($password, $admin['password'])) {
            ...
            $_SESSION['clubname'] = $admin['clubname'];
        ...
        <div class="login-wrapper">
            <div class="login-container">
                ...
                <div class="login-title">Admin Login</div>
                    ...
                    <input type="text" class="input-field" name="clubname" placeholder="Drop the club name here" required>
                    <input type="email" class="input-field" name="email" placeholder="Admin email goes here " required>
                    <div class="password-container">
                        <input type="password" class="input-field" name="password" id="password" placeholder="Password, You better remember it" required>
                        <i class="fas fa-eye" id="togglePassword"></i>
                    </div>
                    <div style="text-align: right;">
                        <a href="#" class="forgot-password-link" onclick="showPopup()">Forgot Password?</a>
                    </div>            
                    <button type="submit" class="login-button"> Enter the Adminverse</button>
                    </form>
                    <div class="signup-link">
                        <p>Not admin yet? <a href="adminsignup.php">Fix that</a></p>
                    <p style="margin-top: 7px;">A humble member? <a href="index.php">Click here</a></p>
                </div>
            </div>
        </div>
    </div>
