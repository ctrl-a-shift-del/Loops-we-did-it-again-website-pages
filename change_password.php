        ...
        <div class="form-container">
            ...
            <form method="POST" action="">
                ...
                <div class="password-container">
                    <input type="password" class="input-field" name="current_password" id="current_password" placeholder="Current password for proof" required>
                    <i class="fa fa-eye" id="toggleCurrentPassword"></i>
                </div>

                <div class="password-container">
                    <input type="password" class="input-field" name="new_password" id="new_password" placeholder="New one? Something unforgettable" required>
                    <i class="fa fa-eye" id="toggleNewPassword"></i>
                </div>

                <input type="password" class="input-field" name="confirm_password" placeholder="New password again. You know the drill " required>
